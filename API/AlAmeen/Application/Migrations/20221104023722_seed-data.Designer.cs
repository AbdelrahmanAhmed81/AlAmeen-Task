...
namespace Application.Migrations
{
    ...
    [Migration("20221104023722_seed-data")]
            ...
            modelBuilder.Entity("Domain.Entites.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CustomerId = 1,
                            Code = "919c99d1-fe3d-4a46-b54a-cf5f2b6cbdae",
                        ...
                        {
                            CustomerId = 2,
                            Code = "ddfdac46-49c1-45da-8d73-6a659c75c508",
            ...
            modelBuilder.Entity("Domain.Entites.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            OrderId = 1,
                            CustomerId = 1,
                            Date = new DateTime(2022, 11, 4, 4, 37, 21, 469, DateTimeKind.Local).AddTicks(2955),
                            Status = "Deliverd",
                            Subtotal = 0m,
                            Tax = 0m,
                            Total = 0m
                        ...
                        new
                        {
                            OrderId = 2,
                            CustomerId = 2,
                            Date = new DateTime(2022, 11, 4, 4, 37, 21, 469, DateTimeKind.Local).AddTicks(2965),
                            Status = "Waiting",
                            Subtotal = 0m,
                            Tax = 0m,
                            Total = 0m
